...
// import gif from "../assets/animateNft.gif";
import gif from "../assets/up1.gif";
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div class="right-detail">
              ...
              <p class="p-2">
                We are not only An NFT in the meta verse, fortunately we are emphasizing the importance of building a strong community revolutionizing entrepreneurship  by hosting in person events and more. There are only 5,000 Geeked gorillas made roaming the meta verse. Claim yours before it’s too late!!
              ...
              <div class="btn-links-wrap">
                <a rel="noreferrer" href="https://discord.gg/6QKNnrAE">
          ...
          <div className="below-links">
            <a href="https://www.Awf.org">Awf.org</a>
